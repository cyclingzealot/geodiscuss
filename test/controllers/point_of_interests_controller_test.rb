...
class PointOfInterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point_of_interest" do
    assert_difference("PointOfInterest.count") do
      post point_of_interests_url, params: { point_of_interest: { description: @point_of_interest.description, latitude: @point_of_interest.latitude, longitude: @point_of_interest.longitude, title: @point_of_interest.title } }
    end
  ...
  test "should update point_of_interest" do
    patch point_of_interest_url(@point_of_interest), params: { point_of_interest: { description: @point_of_interest.description, latitude: @point_of_interest.latitude, longitude: @point_of_interest.longitude, title: @point_of_interest.title } }
